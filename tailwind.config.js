  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        red: colors.red,
        littlewhite: 'rgba(255, 255, 255, 0.8)',
      ...
      fontSize: {
        ...
        '3.5vw': ['3.5vw', { lineHeight: '1' }],
        '13px': ['13px', { lineHeight: '1' }],
        '15px': ['15px', { lineHeight: '1' }],
        '16px': ['16px', { lineHeight: '1' }],
        '28px': ['28px', { lineHeight: '1' }],
      },
      fontWeight: {
        thin: '100',
        extralight: '200',
      ...
      extend: {
        fontFamily: {
          ...
          pretendard: ['Pretendard', 'Spoqa Han Sans Neo', 'sans-serif'],
        },
        //baoro
        width: {
          335: '335px',
